...
type DeviceCommandModel struct {
	...
	// params
	RequestParam map[string]*RequestParamDef `json:"RequestParam,omitempty"`
}

// device event defination
type DeviceEventModel struct {
	Name           string `json:"name"`
	Descriptiohttp string `json:"description,omitempty"`
	// event type
	EventType EventDefType `json:"EventType,omitempty"`
